...
const ViewsColor = colors.GREY_COLOR;

interface IPropsModel {
  color?: string
}

const ViewsNavbar = (props: IPropsModel): JSX.Element => {
      ...
      <AppBar position="static" >
        <Toolbar variant="dense" className={classes.toolbar} style={{background: ViewsColor}}>
          ...
          <IconButton
            ...
            aria-label="menu"
          >
            <Typography className={classes.typoBreadcrumbs2}>VIEWS</Typography>
          </IconButton>
...
export default withRouter(ViewsNavbar);
